exports.seed = function(knex, Promise) {
  return knex('badges').insert([
    ...
    {id: 6, name: 'Skipper', description: 'Skipping more than one task', image: './img/badges/skipper.svg'},
    {id: 7, name: 'Late', description: 'Arrived late', image:'./img/badges/late.svg'}
  ])
  .then(() => {
